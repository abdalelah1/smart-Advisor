...
document.getElementById("savemajorInfo").addEventListener("click", () => {
    const majorName = document.getElementById("majorName").value;

    if (!majorName) {
        alert("Please fill in all required fields.");
    } else {
        alert("Major info saved!");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const saveButton = document.getElementById("savemajorInfo");
    const universityNameInput = document.getElementById("majorName");
